...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_work_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 28, 23)
    ...
    "work\0on_pushButton_clicked\0\0"
...
const QMetaObject work::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_work.data,
      qt_meta_data_work,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_work.stringdata))
