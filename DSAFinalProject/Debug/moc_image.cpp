...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_image_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 53, 23)
    ...
    "image\0on_pushButton_clicked\0\0"
...
const QMetaObject image::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_image.data,
      qt_meta_data_image,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_image.stringdata))
